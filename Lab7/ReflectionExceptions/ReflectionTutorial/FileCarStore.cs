...
public class FileCarStore
{
    public void StoreCars(string path, IEnumerable<Car> cars)
    {
        ...
        {
            // Завдання 5 — зберігаємо також FuelLevel та Odometer
    ...
    public IList<Car> RestoreCars(string path)
    {
        ...
        // Завдання 6 — скидаємо CarsMade перед відновленням
        Car.CarsMade = 0;
        ...
        foreach (var line in fileLines)
        {
            ...
            // Завдання 4 — відновлюємо _fuelLevel та _odometer через Reflection
